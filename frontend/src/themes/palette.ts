...
export const THEME_COLORS: Record<string, { light: ThemePalette; dark: ThemePalette; font: string }> = {
  ...
  clarity: {
    light: { bg: '#F5F0E8', card: '#EFE8DB', cardBorder: 'rgba(35,32,25,0.14)', ink: '#232019', inkSoft: 'rgba(35,32,25,0.64)', inkFaint: 'rgba(35,32,25,0.42)', accent: '#C0692A', accentSoft: '#D98A3D', pink: '#B85C4A', pinkSoft: 'rgba(184,92,74,0.12)', clayShadow: 'none', clayInner: 'none' },
  ...
  mountain: {
    light: { bg: '#E8EEE4', card: '#DDE6D6', cardBorder: 'rgba(43,52,40,0.15)', ink: '#2B3428', inkSoft: 'rgba(43,52,40,0.65)', inkFaint: 'rgba(43,52,40,0.42)', accent: '#4A5D45', accentSoft: '#6B8E6F', pink: '#B8794F', pinkSoft: 'rgba(184,121,79,0.12)', clayShadow: 'none', clayInner: 'none' },
  ...
  forest: {
    light: { bg: '#D4E8D0', card: 'rgba(12,22,11,0.06)', cardBorder: 'rgba(12,22,11,0.12)', ink: '#1A2E18', inkSoft: 'rgba(26,46,24,0.62)', inkFaint: 'rgba(26,46,24,0.40)', accent: '#2E6B2F', accentSoft: '#4CAF50', pink: '#7C5230', pinkSoft: 'rgba(124,82,48,0.12)', clayShadow: 'none', clayInner: 'none' },
  ...
  ocean: {
    light: { bg: '#EBF4FB', card: 'rgba(6,16,30,0.05)', cardBorder: 'rgba(6,16,30,0.10)', ink: '#0A1929', inkSoft: 'rgba(10,25,41,0.60)', inkFaint: 'rgba(10,25,41,0.38)', accent: '#1478A8', accentSoft: '#00B4A8', pink: '#00B4A8', pinkSoft: 'rgba(0,180,168,0.12)', clayShadow: 'none', clayInner: 'none' },
  ...
  'night-sky': {
    light: { bg: '#EEF2FA', card: 'rgba(6,9,26,0.05)', cardBorder: 'rgba(6,9,26,0.10)', ink: '#1A1F36', inkSoft: 'rgba(26,31,54,0.60)', inkFaint: 'rgba(26,31,54,0.38)', accent: '#5B7DB9', accentSoft: '#6B8FD4', pink: '#C9A020', pinkSoft: 'rgba(201,160,32,0.12)', clayShadow: 'none', clayInner: 'none' },
